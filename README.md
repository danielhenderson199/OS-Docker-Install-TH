...
ถ้าสังเกตว่ามีอยู่สองพอร์ต แนะนำไปที่พอร์ต 8006 เพื่อดูระหว่างการติดตั้ง
...
```
แต่​จะมี​ข้อ​เสีย​ในบาง​ ISO จะ​ส่งผลทำ​ไห้​คอนเทนเนอร์​พังได้​ ​เกิด​จาก​การใช้​ทรัพยากรเกินกำหนด​ หากต้องการทดสอบเพิ่มพื้นที่จัดเก็บข้อมูล​แนะนำ​สำหรับ​ Tiny10/11 ต้อง​ปรับ​ค่าแบบนั้​
```
RAM_SIZE: "4G"
CPU_CORES: "2"
DISK_SIZE: "30G"
